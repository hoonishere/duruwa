...
if($member[mb_level] > 8 && $member[mb_level] != 10){
	$flag_view = false;	// <- true로 바꾸면 root 도 다 보임
}
...
<section id="anc_bo_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr <?if(!$mo_flag){?>style="display:none;"<?}?>>
...
<section id="anc_bo_function" <?if(!$flag_view){?> style= "display:none;"<?}?>>
...
<section id="anc_bo_design" >
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
            <tr <?if(!$flag_view){?> style= "display:none;"<?}?>>
...
<section id="anc_bo_point" <?if(!$flag_view){?> style= "display:none;"<?}?>>
...
<?php echo $frm_submit; ?>
<?}?>
<section id="anc_bo_extra" <?if(!$flag_view){?> style= "display:none;"<?}?>>
