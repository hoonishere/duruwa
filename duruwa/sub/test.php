...
?>
    ...
    <input type="hidden" name="page" value="<?php echo $page ?>">
		...
		<div class="s61_img"><img src="<?=G5_URL?>/img/s61_a.jpg"></div>

		<div class="s61_bg">
			<div class="s61">
				<h1>드루와 뷰티와 평생 함께 할 지역별 지부 모십니다.</h1>
			...
			<div class="s61_board">
				<form>
					<table>
						...
						<tr>
							<th>회사명</th>
							<td><input type="text" name="wr_1" value="<?=$write[wr_1]?>" id="wr_1"></td>
						</tr>
						<tr>
							<th>담당자명</th>
							<td><input type="text" name="wr_2" value="<?=$write[wr_2]?>" id="wr_2"></td>
						</tr>
						<tr>
							<th>전화번호</th>
							<td><input type="text" name="wr_3" value="<?=$write[wr_3]?>" id="wr_3"></td>
						</tr>
						<tr>
							<th>휴대폰</th>
							<td><input type="text" name="wr_4" value="<?=$write[wr_4]?>" id="wr_4"></td>
						</tr>
						<tr>
							<th>이메일</th>
		...
		<div class="s61_img"><img src="<?=G5_URL?>/img/s61_c.jpg"></div>
