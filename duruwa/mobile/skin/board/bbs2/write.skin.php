...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="email" name="wr_1" value="<?php echo $write[wr_1] ?>" id="wr_1" class="frm_input email" maxlength="100"></td>
        </tr>
				
        <tr>
            <th scope="row"><label for="wr_2">연락처</label></th>
            <td><input type="text" name="wr_2" value="<?php echo $write[wr_2]?>" id="wr_2" class="frm_input " maxlength="100"></td>
        </tr>
				<?}?>
