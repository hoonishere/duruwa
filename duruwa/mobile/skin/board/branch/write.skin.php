...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="wr_1" value="<?php echo $write[wr_1]?>" id="wr_1" required class="frm_input " style="width:100%;"></td>
        </tr>

				<tr>
            <th scope="row"><label for="wr_2">전화번호<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_2" value="<?php echo $write[wr_2]?>" id="wr_2" required class="frm_input " style="width:100%;"></td>
        </tr>
        ...
        <tr>
            <th scope="row"><label for="wr_link<?php echo $i ?>">지도링크</label></th>
