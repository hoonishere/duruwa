...
<div class="mbskin">
	...
	<div class="regi_frame"><!--  / 전체 틀 -->
         ...
         <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input01 <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" title="아이디">
	...
	<!-- 		<div class="form-item form-item-half">
      ...
      <?php if ($config['cf_use_addr']) { ?>
		...
		<div class="just_line"></div>
			<div class="form-item form-item-full" >
				<div style="width:100%; float:left;font-size: 15px;font-weight:700;font-family: ','LacosteSansBold',', ','맑은 고딕',', ','Malgun Gothic',', ','돋움',', ','Dotum',', ','AppleGothic';color: #454545;">자동등록방지</div>
				<div style="width:100%; float:left "><?php echo captcha_html(); ?></div>
			</div>
...
$(document).ready(function(){ // reg_mb_nick
	...
	<div class="clearfix" >
			<div class="form form-sign-in" style="margin:30px 0; ">
				<div class="form-item form-item-half pad00">
					<button class="btn btn-first mb_skin_btn " id="btn_submit">
						확인
					</button>
				</div>
				<?
				...
				?>
				<div class="form-item form-item-half">
					<button class="btn btn-first mb_skin_btn" style="color:#262626;background-color:#fff;border:1px solid #285f41" onclick="if (window.confirm('<?=$str?>을 취소하시겠습니까?')) {location.href='<?=G5_URL?>';}else{return false}">
						취소
					</button>
				</div>																
			</div><!-- //form -->
