    ...
    <section id="smb_my_ov">
        ...
        <div id="smb_my_act">
            <ul>
                ...
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form_iboard.php" class="btn01">회원정보수정</a></li>
				...
				<table class="tb_order">
					...
					<tr>
						<th>주소</th>
						<td colspan="3"><?php echo sprintf("(%s%s)", $member['mb_zip1'], $member['mb_zip2']).' '.print_address($member['mb_addr1'], $member['mb_addr2'], $member['mb_addr3'], $member['mb_addr_jibeon']); ?></td>
					</tr>
				</table>
