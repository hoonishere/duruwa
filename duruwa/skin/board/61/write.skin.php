...
<!-- 
 ...
 -->
	...
	<table class="guest_table">
		...
		<tr>
			<th>회사명</th>
			<td><input type="text" name="wr_1" value="<?=$write[wr_1]?>" id="wr_1" class="inputbox"></td>
			<th>담당자명</th>
			<td><input type="text" name="wr_2" value="<?=$write[wr_2]?>" id="wr_2" class="inputbox"></td>
		</tr>
		<tr>
			<th>전화번호</th>
			<td><input type="text" name="wr_3" value="<?=$write[wr_3]?>" id="wr_3" class="inputbox"></td>
			<th>휴대폰</th>
			<td><input type="text" name="wr_4" value="<?=$write[wr_4]?>" id="wr_4" class="inputbox"></td>
		</tr>
		<tr>
			<th>이메일</th>
			<td colspan="3"><input type="text" name="wr_5" value="<?=$write[wr_5]?>" id="wr_5" class="inputbox"></td>
		</tr>
		<tr>
			<th>내용</th>
			<td colspan="3">
