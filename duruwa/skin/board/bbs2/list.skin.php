...
<div class="total_board_list_wrap" style="width:<?=$width?>px;">
	...
	<? if ($is_category) { 
		...
		<?
		/*
			$bo_table=="52"이거나  $bo_table=="31" 이면 순서대로 클래스 color 1 ~ 7 까지 부여했습니다.
		*/
		?>

<style>

<?if($bo_table=="52" || $bo_table=="31"){?>
#bo_cate		{display:none;}
<?}?>

<?if($bo_table=="52"||$bo_table=="31"){?>/* 카테고리 별 색깔 바뀌어야 하는아이들 */
#bo_cate h2 {position:absolute;font-size:0;line-height:0;overflow:hidden}
#bo_cate ul {margin-bottom:10px;padding-left:1px; zoom:1}
#bo_cate ul:after {display:block;visibility:hidden;clear:both;content:""}
#bo_cate li {float:left; margin-bottom:-1px}
#bo_cate a				{display:block; float:left;  border:1px solid #dfdfdf; padding:10px 30px; margin-left:-1px; text-decoration:none; font-size:12px;}
#bo_cate a:hover		{background:#f8f8f8;}
#bo_cate #bo_cate_on {color:#fff;}

	/*각 카테고리 별 색깔 지정 */
.color0			{background:#848484 !important; border:1px solid #848484 !important; }/*전체보기임.*/
.color1			{background:#f4b35f !important; border:1px solid #f4b35f !important;}
.color2			{background:#b356ca !important; border:1px solid #b356ca !important;}
.color3			{background:#b8d695 !important; border:1px solid #b8d695 !important;}
.color4			{background:#568fca !important; border:1px solid #568fca !important;}
.color5			{background:#f77ec3 !important; border:1px solid #f77ec3 !important;}
.color6			{background:#767676 !important; border:1px solid #767676 !important;}
.color7			{background:#dcc823 !important; border:1px solid #dcc823 !important;}
...
#bo_cate a:hover		{background:#f8f8f8;}
#bo_cate #bo_cate_on {color:#fff;}
#bo_cate a:focus, #bo_cate a:active {background:#848484; color:#fff; border:1px solid #848484;}
#bo_cate #bo_cate_on {background:#848484; color:#fff; border:1px solid #848484;}
<?}?>
	...
	<div class="board_page">
		...
		$write_pages = str_replace("처음", "<img src='$board_skin_url/img/page_begin.gif' align='absmiddle' title='처음'>", $write_pages);
		$write_pages = str_replace("이전", "<img src='$board_skin_url/img/page_prev.gif' align='absmiddle' title='이전'>", $write_pages);
		$write_pages = str_replace("다음", "<img src='$board_skin_url/img/page_next.gif' align='absmiddle' title='다음'>", $write_pages);
		$write_pages = str_replace("맨끝", "<img src='$board_skin_url/img/page_end.gif' align='absmiddle' title='맨끝'>", $write_pages);
