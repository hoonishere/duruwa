...
<!-- 전체검색 시작 { -->
<form name="fsearch" onsubmit="return fsearch_submit(this);" method="get" style="display:none">
...
<div id="sch_result">
    ...
    <section id="sch_res_ov">
        ...
        <p><?//php echo number_format($page) ?><!-- / --><?//php echo number_format($total_page) ?></p>
	</section>
    <?php
        }
    }
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        <h2 class="search_n_tit"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><?php echo $bo_subject[$idx] ?> <span>게시판 내 결과</span></a></h2>
        <ul>
        <?php
        for ($i=0; $i<count($list[$idx]) && $k<$rows; $i++, $k++) {
         ...
         ?>
            ...
            <li>
                <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>" class="sch_res_title"><b><?php echo $comment_def ?><?php echo $list[$idx][$i]['subject'] ?></b></a>
