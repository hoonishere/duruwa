...
#wowslider-container1 a.ws_next, #wowslider-container1 a.ws_prev {
	...
	height: 45px;
	width: 45px;
	background-image: url(<?=$latest_skin_url?>/img/arrows.png);
}
...
#wowslider-container1 .ws_pause {
    background-image: url(<?=$latest_skin_url?>/img/pause.png);
}

#wowslider-container1 .ws_play {
    background-image: url(<?=$latest_skin_url?>/img/play.png);
}
...
#wowslider-container1  .ws_shadow{
	background-image: url(<?=$latest_skin_url?>/img/bg.png);
...
* html #wowslider-container1 .ws_shadow{/*ie6*/
	background:none;
	filter:progid:DXImageTransform.Microsoft.AlphaImageLoader( src='<?=$latest_skin_url?>/img/bg.png', sizingMethod='scale');
}
