...
$config_form_url = "";
if($is_admin){
	$config_form_url = G5_ADMIN_URL.'/config_form.php';
}else{
	$config_form_url = G5_ADMIN_URL.'/config_form_root.php';
}

$menu['menu100'] = array (
    array('100000', '환경설정', $config_form_url,   'config'),
    array('', '기본환경설정', G5_ADMIN_URL.'/config_form.php',   'cf_basic'),
		array('100110', '(root)기본환경설정', G5_ADMIN_URL.'/config_form_root.php',   ''),
