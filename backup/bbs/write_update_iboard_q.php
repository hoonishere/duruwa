...
$bo_table = $_POST[q_table];
$_POST[bo_table]= $_POST[q_table];

$wr_subject = $_POST[q_subject];
$_POST[wr_subject]= $_POST[q_subject];

$wr_name = $_POST[q_name];
$_POST[wr_name]= $_POST[q_name];

$wr_1 = $_POST[q_1];
$_POST[wr_1]= $_POST[q_1];

$wr_2 = $_POST[q_2];
$_POST[wr_2]= $_POST[q_2];


$wr_3 = $_POST[q_3];
$_POST[wr_3]= $_POST[q_3];


$wr_4 = $_POST[q_4];
$_POST[wr_4]= $_POST[q_4];


$wr_5 = $_POST[q_5];
$_POST[wr_5]= $_POST[q_5];


$wr_6 = $_POST[q_6];
$_POST[wr_6]= $_POST[q_6];


$wr_content = $_POST[q_content];
$_POST[wr_content]= $_POST[q_content];


 $write_table = "g5_write_" . $bo_table;
 $board_skin_path  =   $board_skin_path."bbs2"; // 보테이블과 같은 스킨을 만듦 





// 회원일 경우 mb_name 이름이 영문이 들어가 있으면 글을 못쓰게 막기
if(strlen($member[mb_id]) > 0){
	$mchk = $member[mb_name];
	$chk = 0;

	if(preg_match("/[a-zA-Z]/",$mchk)||trim($mchk) ==""){
