...
?>
<style>
tr.notice_class	{background:#fdfdfd;}
tr.notice_class td a		{ color:#000; font-weight:bold;}
</style>
    ...
    <tr  <?if($list[$i]['is_notice']){ echo"class='notice_class'";}?>> 
        <td class="num">
            <?php
            if ($list[$i]['is_notice']) // 공지사항
                echo '<strong style="color:#ed63a0;">공지</strong>';
