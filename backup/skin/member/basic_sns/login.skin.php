...
include_once(G5_PLUGIN_PATH."/login-oauth-plugin/extend/login-oauth.php");
...
<div id="mb_login" class="mbskin">
    ...
    <fieldset id="login_fs">
        ...
        <label for="login_auto_login">자동로그인</label>
				...
				<!-- facebook login start 2015-05-12-->
...
<div align="left">
    <div ><input type="hidden" id="f_name" name="f_name"></div>
    <div ><input type="hidden" id="f_id" name="f_bool"  ></div>
		<div ><input type="hidden" id="f_email" name="f_email" ></div>
</div>
    </form>
