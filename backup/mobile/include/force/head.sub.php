...
<link rel="stylesheet" href="<?=$head_skin_url?>/assets/css/pushy.css">
...
<?
// bootstrap 
add_stylesheet('<link rel="stylesheet" href="'.$head_skin_url.'/assets/bootstrap/css/bootstrap.min.css">', 1);
//animate.css
add_stylesheet('<link rel="stylesheet" href="'.$head_skin_url.'/assets/wow/animate.css">', 1);
add_stylesheet('<link rel="stylesheet" href="'.$head_skin_url.'/assets/gallery/blueimp-gallery.min.css">', 1);
add_stylesheet('<link rel="stylesheet" href="'.$head_skin_url.'/assets/style.css">', 1);
?>
</head>
