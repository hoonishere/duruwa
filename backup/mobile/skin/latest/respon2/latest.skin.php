...
.flex-control-paging li a:hover { background: #fff; background: rgba(0,0,0,0); }
.flex-control-paging li a.flex-active { background: #33bf10; background: rgba(0.73,0,1,0); cursor: default; }
