...
<ul class="main_qna " id="bxbx1">
	<?for($i=0; $i < count($list) ; $i++){
		...
		?>
		<li style="<?=$style?> margin-top:8px; <?if($i%4==0){?><?}?>">
...
<script src="<?=$latest_skin_url?>/jquery.bxslider.js"></script>
<script>
$(function(){
	var slider = $('#bxbx1').bxSlider({
		mode: 'vertical',
	  slideMargin: 15,
		minSlides: 4,
		maxSlides: 4,
