...
<!-- <fieldset id="bo_sch">
    ...
    <div class="number">
			<input type="submit" value="1" class="btn_num">
			<input type="submit" value="2" class="btn_num">
			<input type="submit" value="3" class="btn_num">
			<input type="submit" value="4" class="btn_num">
		</div>
