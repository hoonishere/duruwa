...
<section id="bo_w">
    ...
    <div class="btn_confirm">
        <input type="submit" value="작성완료" id="btn_submit" class="btn_submit_new" accesskey="s">
				<input type='button' class="btn_cancel_new" value="취소" onclick="location.href='./board.php?bo_table=<?php echo $bo_table ?>'">
    </div>
    </form>
</section>
