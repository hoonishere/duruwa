...
<div id="mb_login01" class="mbskin border_bt">
  ...
  <input type="hidden" name="url" value='<?php echo $login_url ?>'>
			...
			<div class="form-item form-item-full">
					<input type="submit" value="로그인" class="btn-secondary btn-full" style="width:100%;">
			</div>
		<?/* 자동 로그인 빼버림?>
			<div class="form-item form-item-full">
					<div class="btn-secondary btn-full" id="login_auto_login">자동로그인</div>
			</div>
		<?*/?>
			<div class="form-item form-item-full">
			...
			<div class="form-item form-item-full border_top ">
					...
					<div class="form-item form-item-full font">
						귀사의 회원가입은 간편하고 쉽습니다.<br> 
						회원이 아니시라면, 가입 후 더 다양한 서비스를 이용해보세요 지금 가입하세요!
					</div>
					<div class="form-item form-item-full" style="padding:0;">
							<div class="btn-secondary btn-full" id="regi_first">회원가입하기</div>
					</div>
			</div>
    ...
    <?php if ($default['de_level_sell'] == 1) { // 상품구입 권한 ?>
        ...
        <?php if (preg_match("/orderform.php/", $url)) { ?>
				...
				<a href="javascript:guest_submit(document.flogin);" ><div class="btn-secondary btn-full" >비회원으로 구매하기</div></a>
